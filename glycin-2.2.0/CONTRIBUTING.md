...
## Running Bencher Container

Bencher.dev's "bare metal" needs a container. This container will be executed to run the benchmarks.

```sh
$ podman build -t glycin-benchmarks -f build-aux/bencher/Dockerfile .
$ podman run -it glycin-benchmarks
```
