...
lazy_static::lazy_static! {
    ...
    static ref MAKE_TO_ID_MAP: tiff::MakeToIdMap = HashMap::from([
        ...
        sony!("ILCE-6400A", ILCE6400A),
        sony!("ILCE-6500", ILCE6500),
        sony!("ILCE-6600", ILCE6600),
        sony!("ILCE-6700", ILCE6700),
        sony!("ILCE-7", ILCE7),
        sony!("ILCE-7C", ILCE7C),
        sony!("ILCE-7CM2", ILCE7CM2),
        sony!("ILCE-7CR", ILCE7CR),
    ...
    static ref MATRICES: [BuiltinMatrix; 102] = [
        ...
        BuiltinMatrix::new(
            ...
            128,
            0,
            [ 9034, -3489, -777, -4004, 11841, 2448, -484, 1351, 5552 ] ),
        BuiltinMatrix::new(
            sony!(RX10),
            0,
            0,
        ...
        BuiltinMatrix::new(
            ...
            128,
            0,
            [ 10279, -3899, -1462, -7108, 16980, -168, -168, 544, 6116 ] ),
        BuiltinMatrix::new(
            sony!(ILCE3000),
            128,
            0,
        ...
        BuiltinMatrix::new(
            ...
            128,
            0,
            [ 8200, -2975, -719, -4296, 12053, 2532, -429, 1282, 5774 ] ),
        BuiltinMatrix::new(
            sony!(ILCE9),
            128,
            0,
...
impl ArwFile {
    ...
    fn load_rawdata_arw(&self, dir: &Dir) -> Result<RawImage> {
        ...
        container
            .rawdata_with_endian(dir, self.type_(), rawdata_endian)
            .map(|mut rawimage| {
...
impl RawFileImpl for ArwFile {
            ...
            .get_or_try_init(|| {
                ...
                if let Some(maker_note) = self.maker_note_ifd() {
                    if let Some(id) = maker_note.uint_value(exif::MNOTE_SONY_MODEL_ID) {
                        log::debug!("Sony model ID: {id:x} ({id})");
    ...
    fn thumbnails(&self) -> Result<&ThumbnailStorage> {
        self.thumbnails.get_or_try_init(|| {
            self.container()?;
            let container = self.container.get().unwrap();
            Ok(ThumbnailStorage::with_thumbnails(container.thumbnails()))
        })
    }
